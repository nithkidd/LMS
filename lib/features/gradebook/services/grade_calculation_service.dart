...
final gradeCalculationProvider =
    FutureProvider.family<GradeCalculationData, int>((ref, classId) async {
      ...
      for (var student in students) {
        final subjectAverages =
            studentToSubjectYearlyAverage[student.id!] ?? {};
      ...
      for (int i = 0; i < unrankedAdviserRows.length; i++) {
        ...
        final r = unrankedAdviserRows[i].overallPercentage > 0
            ? currentRank
            : 0;
